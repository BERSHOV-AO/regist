...
interface MainApi {
    ...
    //getScheme_AGV_0001_00_00_00_001c(imageName)
    @GET("get_scheme_AGV_0001_00_00_00_001_c.php")
    suspend fun getScheme_AGV_0001_00_00_00_001c(@Query("name") imageName: String):
            Response<ResponseBody>
