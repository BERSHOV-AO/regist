...
object TOData {
    ...
    init {
        ...
        toMap["Очистка (c разборкой)"] = "90"
        toMap["Контроль резбовых соединений, протяжка"] = "30"
        toMap["Осмотр, контроль люфтов"] = "30"
        toMap["Проверить укладку проводов"] = "30"
        toMap["Проверить работу"] = "30"
        toMap["Контроль верхнего положения"] = "30"
        toMap["Смазка"] = "30"
        ...
        toMap["Датчик трека и RFID - Высота от пола"] = "30"

        toMap["Колеса приводные - Контроль диаметра наружного"] = "30"
        toMap["Колеса приводные - Проверить продольный люфт"] = "30"
        toMap["Колеса приводные - Проверить крепление крышки колеса"] = "30"

        toMap["Приводные звездочки - Очистка от мусора"] = "30"
        toMap["Приводные звездочки - Проверить устан. штифты на звездах"] = "30"
        toMap["Приводные звездочки - Проверить крепление крышки звездочки"] = "30"
